...
sleep 1
rm -f /opt/ping/ping.bat /opt/ping/ping6.bat
...
sed "s/^/psping -w 0 -n 1 &/g" /opt/ping/ips.txt >> /opt/ping/ping.bat.temp
...
sed "s/^/psping -w 0 -n 1 &/g" /opt/ping/ip6s.txt >>  /opt/ping/ping6.bat.temp
sed -i "s/$/&:443 >> D:\\\Tools\\\Ping\\\ping6.log/g" /opt/ping/ping6.bat.temp
